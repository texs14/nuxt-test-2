<template>
  <section class="video-upload-form__meta">
    ...
    <div class="video-upload-form__grid">
      <div class="video-upload-form__field">
        ...
        <input
          ...
          :value="title.th"
          @input="onTitle('th', ($event.target as HTMLInputElement).value)"
        />
      </div>
      <div class="video-upload-form__field">
        ...
        <input
          class="video-upload-form__input"
          :value="title.ru"
          @input="onTitle('ru', ($event.target as HTMLInputElement).value)"
        />
      </div>
      <div class="video-upload-form__field">
        ...
        <input
          class="video-upload-form__input"
          :value="title.en"
          @input="onTitle('en', ($event.target as HTMLInputElement).value)"
        />
      </div>
      ...
      <div class="video-upload-form__field">
        ...
        <textarea
          class="video-upload-form__textarea"
          rows="3"
          :value="description.th"
          @input="onDesc('th', ($event.target as HTMLTextAreaElement).value)"
        />
      </div>
      <div class="video-upload-form__field">
        ...
        <textarea
          ...
          @input="onDesc('ru', ($event.target as HTMLTextAreaElement).value)"
        />
      </div>
      <div class="video-upload-form__field">
        ...
        <textarea
          ...
          @input="onDesc('en', ($event.target as HTMLTextAreaElement).value)"
        />
      </div>
      ...
      <div class="video-upload-form__field">
        ...
        <select
          class="video-upload-form__input"
          :value="level"
          @change="onLevel(($event.target as HTMLSelectElement).value)"
        >
    ...
    <div class="video-upload-form__actions">
      ...
      <span v-if="saveOk" class="video-upload-form__hint">{{
        t('meta.saved', { id: String(saveId) })
      }}</span>
    </div>
  </section>
</template>
